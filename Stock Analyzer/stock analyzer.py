...
class GraphicInterface(Frame):
    ...
    def CreateWidgets(self):
        ...
        self.label1.grid(row=0, column=4, padx=5, pady=5)
        # 输入股票代码的文本框
        self.txt1 = Text(self.page1, height=1, width=12)
        self.txt1.grid(row=0, column=5, padx=5, pady=5)
        # 提示文本
        ...
        self.label3.grid(row=2, column=4, padx=5, pady=5)
        # 年份下拉框
        self.yearbox1 = ttk.Combobox(self.page1, width=10, values=self.yearList)
        self.yearbox1.grid(row=2, column=5, padx=5, pady=5)
        # 提示文本“年”
        self.label4 = Label(self.page1, text="年")
        self.label4.grid(row=2, column=6, padx=5, pady=5)
        # 月份下拉框
        self.monthbox1 = ttk.Combobox(self.page1, width=5, values=self.monthList)
        self.monthbox1.grid(row=2, column=7, padx=5, pady=5)
        # 提示文本“月”
        self.label5 = Label(self.page1, text="月")
        self.label5.grid(row=2, column=8, padx=5, pady=5)
        # 日期下拉框
        self.daybox1 = ttk.Combobox(self.page1, width=5, values=self.dayList)
        self.daybox1.grid(row=2, column=9, padx=5, pady=5)
        # 提示文本“日”
        self.label6 = Label(self.page1, text="日")
        self.label6.grid(row=2, column=10, padx=5, pady=5)
        # 提示文本
        ...
        self.alertButton1.grid(row=6, column=5, columnspan=2, padx=5, pady=10)
        
        # “对比分析”选项卡
        #self.page2 = ttk.Frame(self.nb)
        # “对比分析”页图片
        #self.image2 = Label(self.page2, image=img)
        #self.image2.grid(row=0, column=0, padx=10, pady=10)
    ...
    def CheckInput1(self):
        ...
        if stockCode == "":
            ...
            data = ts.get_hist_data(stockCode, start=startDate, end=endDate, ktype='D', retry_count=100)    # 用tushare获取数据
